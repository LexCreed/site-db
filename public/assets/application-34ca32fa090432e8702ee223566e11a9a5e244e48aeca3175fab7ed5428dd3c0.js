...
(function() {
  $(document).on("ajax:success", "form#comments-form", function(ev, data) {
    ...
    return $("#comments-box").append("<artticle><header class='text-right be-small'><br><a href='#'></a></header><div class='row'><div class='col-xs-1 col-md-1'><div class='box'><img src=" + data.user.avatar + "></div></div> - <div class='col-xs-11 col-md-10'><ul><div class='box'>" + data.body + " - " + data.user.email + "</div></ul></div></div></article>");
  });
